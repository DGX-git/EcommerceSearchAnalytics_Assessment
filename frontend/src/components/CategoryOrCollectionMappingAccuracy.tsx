...
// interface CategoryMappingAccuracyData {
//   mapping: string;
//   accuracy: number;
// }

// export const CategoryOrCollectionMappingAccuracy: React.FC = () => {
//   const [data, setData] = useState<CategoryMappingAccuracyData[]>([]);
...
//       try {
//         setLoading(true);
//         const result:any = await analyticsAPI.getCategoryOrCollectionMappingAccuracy();
//         setData(result);
//       } catch (err) {
...
//       <h1>Category or Collection Mapping Accuracy</h1>
//       <table>
//         <thead>
//           <tr>
//             <th>Mapping</th>
...
//         setData(chartData as MappingAccuracyData[]);
//       } catch (err) {
//         setError(err instanceof Error ? err.message : 'Failed to fetch data');
//       } finally {
//         setLoading(false);
...
//     <Card sx={{ m: 2 }}>
//       <CardContent>
//         <Typography variant="h5" sx={{ mb: 2 }}>Category/Collection Mapping Accuracy</Typography>
...
//               <PieChart>
//                 <Pie data={data} dataKey="accuracy" nameKey="category" cx="50%" cy="50%" outerRadius={100} label>
