...
//       try {
//         setLoading(true);
//         const result:any = await analyticsAPI.getHighExitSearches();
//         setData(result);
//       } catch (err) {
...
//     <Card sx={{ m: 2 }}>
//       <CardContent>
//         <Typography variant="h5" sx={{ mb: 2 }}>High Exit Searches</Typography>
...
//                 <Tooltip />
//                 <Legend />
//                 <Area type="monotone" dataKey="exit_rate" fill="#ff7300" stroke="#ff7300" />
//               </AreaChart>
//             </ResponsiveContainer>
//           </Box>
//         )}
